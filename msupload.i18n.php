<?php
/**
 * Internationalisation file for extension MsUpload.
 *  
 ...
 */
$messages['de'] = array(
		'msu-desc' => 'Ermöglicht einfache Uploads (wenn verfügbar auch per drag&drop) für eine oder mehrere Dateien gleichzeitig',
        'msu-button_title' => 'Datei(en) auswählen',
        'msu-insert_link' => 'als Link einfügen',
        'msu-insert_gallery' => 'Bilder als Gallery einfügen',
...
$messages['ru'] = array(
		...
		'msu-insert_link' => 'Вставить ссылку',
		'msu-insert_gallery' => 'Вставить картинки как галерея',
		...
		'msu-upload_all' => 'Щелкните, чтобы загрузить все файлы',
		'msu-dropzone' => 'Перетащите файлы сюда',
		'msu-comment' => 'MsUpload',		
);
/** Chinese Simplified 
...
$messages['pt-br'] = array(
        ...
        'msu-insert_link' => 'Inserir link',
        'msu-insert_gallery' => 'Inserir imagem como galeria',
